...
int* filenameToAudio(int* FileName)
{
	...
	if (strcmp(FileName, "destroy") == 0)
	{
		result = (int*) malloc(sizeof(int));
		*result = 1;
	}
	
	if (strcmp(FileName, "leveleditorselect") == 0)
	{
		result = (int*) malloc(sizeof(int));
		*result = 2;
	}

	if (strcmp(FileName, "score") == 0)
	{
		result = (int*) malloc(sizeof(int));
		*result = 3;
	}

	if (strcmp(FileName, "winexit") == 0)
	{
		result = (int*) malloc(sizeof(int));
		*result = 4;
	}

	if (strcmp(FileName, "directionmove") == 0)
	{
		result = (int*) malloc(sizeof(int));
		*result = 5;
	}

	if (strcmp(FileName, "gameover") == 0)
	{
		result = (int*) malloc(sizeof(int));
		*result = 6;
	}
	...
	if (strcmp(FileName, "win") == 0)
	{
		result = (int*) malloc(sizeof(int));
		*result = 8;
	}

	if (strcmp(FileName, "nomoves") == 0)
	{
		result = (int*) malloc(sizeof(int));
		*result = 9;
	}
